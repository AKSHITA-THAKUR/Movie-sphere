...
import { getTVPopular } from '../feature/TvSlice'
...
const TvPopular:React.FC = () => {
    ...
    const AiringToday = useSelector((state: RootState) => state.TvSlice.popular)
  ...
  return (
    <div>
     <div className="ml-[100px] mt-10">
            <div>
                <h1 className="text-2xl font-bold text-white">Popular TV Shows...</h1>
             </div>
            ...
            <div className="relative w-[1100px]">
                <div className="flex items-center">
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 z-10 p-2 bg-gray-600 rounded-full hover:bg-gray-400 cursor-pointer"
                    >
                        <FaArrowLeft />
                    </button>
